<?php
/**
 * Privacy Policy (Premium Reassuring View)
 */
?>
<style>
.legal-hero {
...
<div class="legal-hero anim-fade-up">
    <div class="container px-3 position-relative" style="z-index: 10;">
        ...
        <p class="legal-subtitle">Your privacy and security are our highest priorities. We are committed to protecting your personal data with enterprise-grade security.</p>
    </div>
</div>
            ...
            <div class="col-lg-8 anim-fade-up" style="animation-delay: 0.1s;">
                <div class="legal-card">
                    <div class="d-flex justify-content-between align-items-center mb-5 pb-4 border-bottom">
                        <span class="text-muted fw-bold text-uppercase" style="font-size: 0.85rem; letter-spacing: 1px;">Last Updated: <?php echo date('F d, Y'); ?></span>
                    ...
                    <div class="trust-badge">
                        ...
                        <div>
                            ...
                            <div class="text-muted fw-normal" style="font-size: 0.9rem;">Your data is protected by industry-leading encryption protocols.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 anim-fade-up" style="animation-delay: 0.2s;">
                <div class="legal-sidebar">
                    <div class="contact-legal-card">
                        ...
                        <p class="text-muted mb-4" style="font-size: 0.95rem;">If you have any questions regarding how we handle your data, our Data Protection Officer is here to help.</p>
                        <a href="mailto:privacy@propertyrubix.com" class="btn btn-outline-primary w-100 fw-bold rounded-pill">Contact Privacy Team</a>
                    </div>
                </div>
            </div>
        </div>
